...
| *SPEC-008* | *(reservada — Schema do YAML de configuração)* | — | reservado | Número reservado por **DEC-006** §2 ao schema do YAML de configuração da reunião, SPEC técnica da Onda 2. Não existe arquivo enquanto a reserva vigora. |
